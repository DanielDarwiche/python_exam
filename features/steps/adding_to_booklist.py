...
def entering_only_author_input(context):
    page = context.page
...
def verify_disabled_button(context):
    page = context.page
...
def input_author_and_title(context):
    page = context.page
    inputs = page.locator('div.form input')
    title_input = inputs.nth(0)
    author_input = inputs.nth(1)
...
def verify_enabled_button(context):
    page = context.page
    add_button = page.locator('div.form button[type="submit"]')
